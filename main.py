...
if __name__ == '__main__':
    ...
    st.text('This is a platform that can detect calcified lesions and tumor lesions of breast cancer.You can choose to detect the lesions here and then enter your breast picture on the page.')
